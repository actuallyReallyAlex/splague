...
const stepOne = variableObject => {
  const vectors = {
    d1: binomial(variableObject.humans.SH, epidemiologicalModel.humans.bH),
    d2: binomial(variableObject.humans.SH, epidemiologicalModel.humans.dH),
    d3: binomial(variableObject.rats.SR, d3Equation(variableObject)),
    d4: binomial(variableObject.rats.IR, epidemiologicalModel.rats.γR),
    d5: binomial(variableObject.rats.Q, epidemiologicalModel.rats.δR),
    d6: binomial(variableObject.humans.SH, d6Equation(variableObject)),
